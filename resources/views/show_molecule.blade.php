...
@if($art->comments_count < 2) <a href='#coms' class="button is-primary" id="com">{{$art->comments_count}}
    ...
    <div class="container column is-8">
        <section class="section">
                            ...
                            <div class="dropdown-menu" id="dropdown-menu6" role="menu">
                                <div class="dropdown-content has-background-white">
                                    <div class="dropdown-item">
                                        ...
                                        <p><a class="nav-link has-text-grey-dark is-family-primary has-text-weight-semibold is-size-6"
                                                href="{{ route('show_article', [ 'id'=> $titre->id ]) }}">{{$titre->title}}</a>
                                        </p>
                            ...
                            <div class="dropdown-menu" id="dropdown-menu5" role="menu">
                                <div class="dropdown-content has-background-white">
                                    <div class="dropdown-item">
                                        ...
                                        <p><a class="nav-link has-text-grey-dark is-family-primary has-text-weight-semibold is-size-6"
                                                href="{{ route('show_lineament', [ 'id'=> $des->id ]) }}">{{$des->title}}</a>
                                        </p>
                                        <hr class="dropdown-divider">
                                        @endforeach
                                        @endforeach
            ...
            @auth
            @foreach($molecule as $molecule_id)
            <form action="{{route('post_comment', [ 'id'=> $molecule_id->id ])}}" method="POST">
                @csrf

                <textarea id="content" name="content" -model="content" cols="87" rows="5"
                    style="line-height: 105%"></textarea>
